...
public class Life extends JFrame implements MouseListener, KeyListener, Runnable{
    ...
    public void keyPressed(KeyEvent v){
        switch(v.getKeyCode()){
            ...
            break;
            case 107: if(delay>5) delay -= 10; message("delay :" + delay); //Up - speed up
            break;
            case 109: delay += 10; message("delay :" + delay);              //Down - speed down 
            break;
            case '0': commline();
